...
namespace VeriDoc_HR.Controllers
{
    public class AdminAppController : Controller
    {
        ...
        public ActionResult btn_Head_Save_Click(FormCollection form, HttpPostedFileBase fu_Image_1, HttpPostedFileBase fu_Image_2, HttpPostedFileBase fu_Image_3, HttpPostedFileBase fu_Image_4, HttpPostedFileBase fu_Image_5, HttpPostedFileBase fu_Image_6)
        {
            ...
            String LOGO_NAME_1 = String.Empty, LOGO_NAME_2 = String.Empty, LOGO_NAME_3 = String.Empty, LOGO_NAME_4 = String.Empty,
            LOGO_NAME_5 = String.Empty, LOGO_NAME_6 = String.Empty;
            ...
            EntityHowItWorkAdminApp oBMAST = null;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    errMsg = String.Empty;
                    oBMAST = new EntityHowItWorkAdminApp();
                    ...
                    using (BaHowItWorkAdminApp oBMC = new BaHowItWorkAdminApp())
                    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (allowedExtensions.Contains(ext)) //check what type of extension  
                    {
                        ...
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP1" + ext; //appending the name with id  
        ...
        private String ProcessImage2(ref String Doc_Name, HttpPostedFileBase file)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string name = Path.GetFileNameWithoutExtension(fileName); //getting file name without extension  
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP2" + ext; //appending the name with id  
                                                                                                        // store the file inside ~/project folder(Img)  
                        var path = Server.MapPath(DOC_PATH + myfile);
                        Image_url = path;
        ...
        private String ProcessImage3(ref String Doc_Name, HttpPostedFileBase file)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string name = Path.GetFileNameWithoutExtension(fileName); //getting file name without extension  
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP3" + ext; //appending the name with id  
                                                                                                        // store the file inside ~/project folder(Img)  
                        var path = Server.MapPath(DOC_PATH + myfile);
                        Image_url = path;
        ...
        private String ProcessImage4(ref String Doc_Name, HttpPostedFileBase file)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string name = Path.GetFileNameWithoutExtension(fileName); //getting file name without extension  
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP4" + ext; //appending the name with id  
                                                                                                        // store the file inside ~/project folder(Img)  
                        var path = Server.MapPath(DOC_PATH + myfile);
                        Image_url = path;
        ...
        private String ProcessImage5(ref String Doc_Name, HttpPostedFileBase file)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string name = Path.GetFileNameWithoutExtension(fileName); //getting file name without extension  
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP5" + ext; //appending the name with id  
                                                                                                        // store the file inside ~/project folder(Img)  
                        var path = Server.MapPath(DOC_PATH + myfile);
                        Image_url = path;
        ...
        private String ProcessImage6(ref String Doc_Name, HttpPostedFileBase file)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string name = Path.GetFileNameWithoutExtension(fileName); //getting file name without extension  
                        string myfile = System.DateTime.Now.ToString("yyyyMMdd_hhmmss") + "-APP6" + ext; //appending the name with id  
                                                                                                        // store the file inside ~/project folder(Img)  
                        var path = Server.MapPath(DOC_PATH + myfile);
                        Image_url = path;
