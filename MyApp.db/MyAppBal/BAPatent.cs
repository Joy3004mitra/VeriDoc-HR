...
{
    public class BAPatent: IDisposable
    {
        Int16 vCount = 0;
        DataSet ds = null;
        DataTable dt = null;
        ...
        public DataTable Get<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_GET_DTLS_PATENT", CommandType.StoredProcedure))
                {
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityPatent oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount] = new SqlParameter("@PATENT_KEY", SqlDbType.Int);
                para[vCount++].Value = oEntity.PATENT_KEY;
                //para[vCount] = new SqlParameter("@QUICK_FACT_IMG", SqlDbType.VarChar, 50);
                //para[vCount++].Value = oEntity.QUICK_FACT_IMG;
                para[vCount] = new SqlParameter("@PATENT_DESC", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.PATENT_DESC;
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_SAVE_DTLS_PATENT", CommandType.StoredProcedure))
                {
        ...
        public byte QuickFactDelete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            byte retKey = 0;
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_DELETE_DTLS_PATENT", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
