...
{
    public class EntityHowItWorkAdminApp
    {
        ...
        public String HEADING_FIVE { get; set; }
        public String DESC_FIVE { get; set; }
        public String IMAGE_FIVE { get; set; }

        public String HEADING_SIX { get; set; }
        public String DESC_SIX { get; set; }
        ...
        public EntityHowItWorkAdminApp() { }
    }
}
